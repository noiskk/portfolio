    ...
    public void run(ApplicationArguments args) {
        ...
        projectRepository.saveAll(List.of(
            Project.builder()
                ...
                .demoUrl(null)
                .readmeSlug(null)
                .techStack(List.of("Spring Boot 3.4", "Spring AI", "Qdrant", "Redis", "Next.js", "OpenAI API", "Docker"))
            ...
            Project.builder()
                ...
                .demoUrl(null)
                .readmeSlug("sofit")
                .techStack(List.of("AWS", "OpenStack", "WireGuard", "MySQL InnoDB Cluster", "Jenkins", "CodeDeploy", "Spring Boot", "Prometheus/Grafana"))
                .role(List.of(
            ...
            Project.builder()
                ...
                .techStack(List.of("Java 17", "Spring Boot 3.2", "Spring Cloud Gateway", "Eureka", "OpenFeign", "Spring Batch", "MySQL", "ISO 8583"))
                .role(List.of(
